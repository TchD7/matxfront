    ...
    useEffect(() => {
        const fetchFilters = async () => {
            try {
                ...
                toast({ title: 'Erreur', description: 'Impossible de charger les filtres.', status: 'error' });
            }
        };
        fetchFilters();
    }, [toast]);
        ...
        <Container maxW="full" p={0}>
            <Flex direction="column">
                <Box mb={6}>
                    ...
                    {/* Filtres ... (votre code reste identique) */}
                </Box>

                {/* MODIFICATION CLÉ ICI : 
                   On utilise la navigation React Router au lieu d'une prop de callback 
                */}
                <TicketTable
                    tickets={tickets}
                    loading={loading}
                ...
                <HStack justify="space-between" mt={4}>
                    <Select w="100px" size="sm" value={pageSize} onChange={(e) => setPageSize(Number(e.target.value))}>
